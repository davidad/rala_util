...
void rala_glyph_bg_clear_day(cairo_t* cr) {
	cairo_new_path(cr);
...
void xor_gate_glyph_day(cairo_t *cr) {
...
void or_gate_glyph_day(cairo_t *cr) {
	static cairo_pattern_t *pat = 0;
...
void and_gate_glyph_day(cairo_t *cr) {
	static cairo_pattern_t *pat = 0;
...
void nand_gate_glyph_day(cairo_t *cr) {
	static cairo_pattern_t *pat = 0;
...
void stem_cell_glyph_day(cairo_t *cr) {
	static cairo_pattern_t *pat = 0;
...
void hollow_stem_cell_glyph_day(cairo_t *cr) {
	cairo_save(cr);
	cairo_translate(cr,0.1,0.1);
	cairo_scale(cr,0.8,0.8);
...
void crossover_cell_glyph_day(cairo_t *cr) {
	static cairo_pattern_t *pat = 0;
...
void wire_cell_glyph_day(cairo_t *cr) {
	static cairo_pattern_t *pat = 0;
...
void delete_cell_glyph_day(cairo_t *cr, int rotation) {
	static cairo_pattern_t *pat = 0;
...
void copy_cell_glyph_day(cairo_t *cr, int rotation) {
	static cairo_pattern_t *pat = 0;
...
void arrow_none_glyph_day(cairo_t *cr) {
	cairo_save(cr);
...
void arrow_x_glyph_day(cairo_t *cr) {
	cairo_save(cr);
	cairo_translate(cr,ARROW_POS_X,ARROW_POS_Y);
...
void arrow_0_glyph_day(cairo_t *cr) {
...
void arrow_1_glyph_day(cairo_t *cr) {
	static cairo_pattern_t *pat_in, *pat_out = 0;
...
void blank_cell_day(cairo_t *cr) {
	cairo_save(cr);
	cairo_new_path(cr);
