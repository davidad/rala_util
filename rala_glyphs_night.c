...
void rala_glyph_bg_clear_night(cairo_t* cr) {
	cairo_new_path(cr);
...
void xor_gate_glyph_night(cairo_t *cr) {
	...
	if(pat == 0) {
		...
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.18, 0.18, 0.4);
	}

	rala_glyph_bg_clear_night(cr);
...
void or_gate_glyph_night(cairo_t *cr) {
	...
	if(pat == 0) {
		pat = cairo_pattern_create_radial (0.35, 0.3, 0.08, 0.2, 0.35, 0.6);
		cairo_pattern_add_color_stop_rgb (pat, 0, 0.7, 0.7, 0.7);
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.18, 0.4, 0.18);
	}
...
void and_gate_glyph_night(cairo_t *cr) {
	...
	if(pat == 0) {
		...
		cairo_pattern_add_color_stop_rgb (pat, 0, 0.7, 0.7, 0.7);
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.4, 0.18, 0.18);
	}
...
void nand_gate_glyph_night(cairo_t *cr) {
	...
	if(pat == 0) {
		pat = cairo_pattern_create_radial (0.27, 0.3, 0.08, 0.2, 0.35, 0.6);
		cairo_pattern_add_color_stop_rgb (pat, 0, 0.7, 0.7, 0.6);
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.5, 0.5, 0.3);
	}
...
void stem_cell_glyph_night(cairo_t *cr) {
	...
	if(pat == 0) {
		pat = cairo_pattern_create_radial (0.27, 0.3, 0.08, 0.2, 0.35, 0.6);
		cairo_pattern_add_color_stop_rgb (pat, 0, 0.7, 0.7, 0.7);
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.4, 0.4, 0.4);
	}
...
void crossover_cell_glyph_night(cairo_t *cr) {
	...
	if(pat == 0) {
		pat = cairo_pattern_create_radial (0.27, 0.3, 0.08, 0.2, 0.35, 0.6);
		cairo_pattern_add_color_stop_rgb (pat, 0, 0.7, 0.7, 0.7);
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.4, 0.2, 0.4);
	}
...
void wire_cell_glyph_night(cairo_t *cr) {
	...
	if(pat == 0) {
		...
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.2, 0.18, 0.1);
	}
...
void delete_cell_glyph_night(cairo_t *cr, int rotation) {
	...
	if(pat == 0) {
		pat = cairo_pattern_create_radial (0.27, 0.3, 0.08, 0.2, 0.35, 0.6);
		cairo_pattern_add_color_stop_rgb (pat, 0, 0.7, 0.7, 0.7);
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.4, 0.2, 0.1);
	}
...
void copy_cell_glyph_night(cairo_t *cr, int rotation) {
	...
	if(pat == 0) {
		pat = cairo_pattern_create_radial (0.27, 0.3, 0.08, 0.2, 0.35, 0.6);
		cairo_pattern_add_color_stop_rgb (pat, 0, 0.7, 0.7, 0.7);
		cairo_pattern_add_color_stop_rgb (pat, 1, 0.1, 0.5, 0.2);
	}
		...
		for(y=user_y_int; y<user_y_int+user_h_int; y+=2) {
			for(x=user_x_int; x<user_x_int+user_w_int; x+=2) {
				...
				if(blank_cell_style==HOLLOW_STEM) {
					hollow_stem_cell_glyph_night(cr);
